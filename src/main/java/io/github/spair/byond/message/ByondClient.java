...
public final class ByondClient {
     ...
     * @return Response from BYOND server as {@link ByondResponse} or null, if expected response is {@link ResponseType#NONE}
     * @throws HostUnavailableException    signals that requested server unavailable to connect
     ...
     * <p>Method is <b>not recommended</b> to be used, due to extra wait time from timeout, and possibility of shredding data if timeout is too low.
     *
     * @param byondMessage message object to send
    ...
    private void validateResponseType(ResponseType expected, ResponseType actual) throws UnexpectedResponseException {
